...
def _convert_examples_to_features(
	...
	features = []
	for i in tqdm(range(len(examples)), desc="Converting examples to features", position=0, leave=True, total=len(examples)):
...
class TrecProcessor(DataProcessor):
	...
	def get_label_map(self):
		label_map = {"0": "Description", "1": "Entity", "2": "Expression", "3": "Human", "4": "Location", "5": "Number"}
...
task_to_keys = {
	"cola": ("sentence", None),
	"mnli": ("premise", "hypothesis"),  # Sentence Pair Tasks: Used by SPT
	"mrpc": ("sentence1", "sentence2"),  # Sentence Pair Tasks: Used by SPT, IDPG
	"qnli": ("question", "sentence"),  # Sentence Pair Tasks: Used by SPT, IDPG
	"qqp": ("question1", "question2"),  # Sentence Pair Tasks: Used by SPT, IDPG
	"rte": ("sentence1", "sentence2"),  # Sentence Pair Tasks: Used by SPT, IDPG
	"sst2": ("sentence", None),  # Single Sentence Tasks: Used by SPT, IDPG
	"stsb": ("sentence1", "sentence2"),  # Sentence Pair Tasks: Used by IDPG
