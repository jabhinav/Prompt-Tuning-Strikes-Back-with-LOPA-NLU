...
for t in prompt_len:
	...
	config = RobertaConfig.from_pretrained(get_huggingface_path(args1.enc_model_type))
	base = RobertaModel.from_pretrained(get_huggingface_path(args1.enc_model_type))
